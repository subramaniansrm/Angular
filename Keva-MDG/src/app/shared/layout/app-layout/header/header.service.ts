...
export class HeaderService {
 ...
 // mailDetails: any = [];
  ...
  headerDetails():Observable<{}>{
    ...
    //headers.append('access_token', localStorage.getItem("kiosk_access_token"));
    let headeroptions = new RequestOptions({ headers: headers });
    return this.http.post("http://172.16.1.72:8081/kevamdg/sr/name/dropdown",{id:Number(localStorage.getItem("userId"))}, headeroptions );
  ...
  mailDetails(): Observable<{}> {
    ...
    return this.http.post("//172.16.1.72:8181/kiosk/sr/notificationList",{}, headeroptions );
