...
export class LoginService {
  ...
  postlogin(username, password): Observable<{}> {
    ...
    let bodycontent = { "username": username, "password": btoa(password), "grantType": "password" }
   // return this.http.post("http://172.16.9.103:8081/kevamdg/core/oauth/token", bodycontent, headeroptions );
    return this.http.post("http://kioskuat:8091/kevamdg/core/oauth/token", bodycontent, headeroptions);
  ...
  login(): Observable<{}> {
    return this.http.get("http://kioskuat:8091/kevamdg/home");
  //  return this.http.get("http://knitsso:8090/kevamdg/home");
  }
